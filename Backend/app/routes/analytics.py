...
def team_performance():
    """
     SQL queries for team performance analytics.
    ...
    # Simplerer query that works with SQLite
...
def player_statistics():
    """
     query demonstrating JOIN operations and aggregations
    ...
    if position:
        # binding prevents SQL injection
...
def team_comparison():
    """
     team comparison analytics with multiples metrics.
